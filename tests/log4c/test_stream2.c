static const char version[] = "$Id: test_stream2.c,v 1.5 2012/10/04 22:51:28 valtri Exp $";
...
static void log4c_print(FILE *a_fp)
{
    ...
    sd_factory_print(log4c_category_factory, a_fp);
    fprintf(a_fp, "\n");
    sd_factory_print(log4c_appender_factory, a_fp);
    fprintf(a_fp, "\n");
    sd_factory_print(log4c_layout_factory, a_fp);
    fprintf(a_fp, "\n");
}
